(defproject connect-four "0.1.0-SNAPSHOT"
  ...
  :ring {:handler connect-four.handler/app
         :uberwar-name "connect-four.war"}

  :min-lein-version "2.5.0"

  :uberjar-name "connect-four.jar"

  :main connect-four.server
  ...
  :profiles {:dev {:repl-options {:init-ns connect-four.dev
             ...
             :production {:ring {:open-browser? false
                                 :stacktraces?  false
                                 :auto-reload?  false}
                          :cljsbuild {:builds {:app {:compiler {:main "connect-four.prod"}}}}}})
