...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__4663__auto__,writer__4664__auto__,opt__4665__auto__){
return cljs.core._write(writer__4664__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var i_21181 = (0);
while(true){
if((i_21181 < arr.length)){
(arr[i_21181] = null);

var G__21182 = (i_21181 + (1));
i_21181 = G__21182;
continue;
} else {
}
...
var i_21194 = (self__.level + (1));
while(true){
if((i_21194 <= (new_level + (1)))){
(update[i_21194] = self__.header);

var G__21195 = (i_21194 + (1));
i_21194 = G__21195;
continue;
} else {
}
...
var i_21196 = (0);
while(true){
if((i_21196 <= self__.level)){
var links_21197 = (update[i_21196]).forward;
if(((links_21197[i_21196]) === x__$1)){
(links_21197[i_21196] = (x__$1.forward[i_21196]));

var G__21198 = (i_21196 + (1));
i_21196 = G__21198;
continue;
} else {
var G__21199 = (i_21196 + (1));
i_21196 = G__21199;
continue;
}
} else {
...
if(!((nx == null))){
var G__21201 = nx;
var G__21202 = (level__$1 - (1));
x = G__21201;
level__$1 = G__21202;
continue;
} else {
var G__21203 = x;
var G__21204 = (level__$1 - (1));
x = G__21203;
level__$1 = G__21204;
continue;
}
...
var G__21206 = nx;
var G__21207 = (level__$1 - (1));
x = G__21206;
level__$1 = G__21207;
continue;
} else {
var G__21208 = x;
var G__21209 = (level__$1 - (1));
x = G__21208;
level__$1 = G__21209;
continue;
}
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__4663__auto__,writer__4664__auto__,opt__4665__auto__){
return cljs.core._write(writer__4664__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
var or__4076__auto__ = (cljs.core.truth_((function (){var and__4064__auto__ = me;
...
cljs.core.async.impl.dispatch.queue_delay(((function (timeout_channel,or__4076__auto__,timeout__$1,me){
return (function (){
cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);

return cljs.core.async.impl.protocols.close_BANG_(timeout_channel);
});})(timeout_channel,or__4076__auto__,timeout__$1,me))
,msecs);
