...
return s.replace((new RegExp((function (){var G__17430 = match;
return goog.string.regExpEscape(G__17430);
})(),"g")),replacement);
} else {
...
while(true){
if(coll__$1){
var G__17431 = sb.append([cljs.core.str(cljs.core.first(coll__$1))].join(''));
var G__17432 = cljs.core.next(coll__$1);
sb = G__17431;
coll__$1 = G__17432;
continue;
} else {
...
var G__17435 = cljs.core.pop(v__$1);
v__$1 = G__17435;
continue;
} else {
return v__$1;
...
var pred__17443 = cljs.core._EQ_;
var expr__17444 = limit;
if(cljs.core.truth_((function (){var G__17446 = (1);
...
if(cljs.core.truth_((function (){var G__17448 = (2);
...
var G__17453 = s__$1.substring((index + cljs.core.count(m)));
var G__17454 = (limit__$1 - (1));
var G__17455 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parts,s__$1.substring((0),index));
s__$1 = G__17453;
limit__$1 = G__17454;
parts = G__17455;
continue;
...
var G__17457 = s;
return goog.string.trim(G__17457);
});
/**
...
var G__17459 = s;
return goog.string.trimLeft(G__17459);
});
/**
...
var G__17461 = s;
return goog.string.trimRight(G__17461);
});
/**
...
var G__17464 = s;
return goog.string.isEmptySafe(G__17464);
});
/**
...
var temp__4124__auto___17465 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cmap,ch);
if(cljs.core.truth_(temp__4124__auto___17465)){
var replacement_17466 = temp__4124__auto___17465;
buffer.append([cljs.core.str(replacement_17466)].join(''));
} else {
buffer.append(ch);
}

var G__17467 = (index + (1));
index = G__17467;
continue;
}
break;
